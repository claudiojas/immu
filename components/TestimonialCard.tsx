...
const TestimonialCard = ({ image, name, age, text, videoUrl }: TestimonialCardProps) => {
  return (
    <div className="bg-[#F0F0F0] h-[32rem] rounded-2xl shadow-lg p-6 flex flex-col items-center justify-between text-center max-w-sm transition-transform hover:scale-[1.02] duration-300 border border-manancial-purple">
      {/* Foto Redonda */}
